...
const VALIDATOR_TYPE_POSITIVE="POSITIVE";
const VALIDATOR_TYPE_PAN="PAN"
...
export const VALIDATOR_PAN=()=>(
	{
		type:VALIDATOR_TYPE_PAN
	}
);
...
export const VALIDATOR_POSITIVE=()=>(
	{
		type:VALIDATOR_TYPE_POSITIVE
	}
);
